...
from attrdict.orderedattrdict import OrderedAttrDict as AttrDict

def from_yaml(loader: Loader, node: MappingNode) -> Generator[AttrDict, None, None]:
    "Load mapping as OrderedAttrDict, preserving order."
    ...
    for key_node, value_node in node.value:
        ...
        try:
            ...
            raise ConstructorError(
                ...
                'found unacceptable key (%s)' % error, key_node.start_mark
            )
...
def to_yaml(dumper: Any, data: Any) -> Any:
